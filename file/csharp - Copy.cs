<p class="alert alert-info">//using
//اضافه کردن منابع و کتابخانه ها به پروژه
//همیشه به ابتدای صفحه کد اضافه می شوند
</p>
...
//1
///*Console.*/WriteLine("Hello, World!"); //WriteLine() -> نمایش محتوی و نتیجه در محیط کنسول
//WriteLine("farda"); //string | متن

//عملگرهای ریاضی : +, -, *, /, %
//2
//WriteLine(4 + 5); //int (integer) | عدد صحیح
//WriteLine(7 * 3);
//WriteLine(3 - 9);
//WriteLine(8 / 2);
//WriteLine(5 / 3);
//WriteLine(5.0 / 3); //double | عدد اعشاری تا 15 رقم
//WriteLine(5 / 3.0 );
//WriteLine(5 / 3.0 );
//WriteLine(8 % 2); //باقیمانده
//WriteLine(7 % 2);

//عملگرهای مقایسه ای : >, >=, <, <=, !=
//3
//WriteLine(7 > 2); //bool (boolean) | منطق -> true, false
//WriteLine(5 >= 5);
//WriteLine(5 < 3);
//WriteLine(5 != 6); //مقایسه نابرابری
//WriteLine(5 == 6); //مقایسه برابری
//WriteLine(!(5 == 6)); //نقیض یا مخالف ساز

//هر چیزی داخل "" -> متن
//حتی اعداد -> "5" عدد نیست 
//4
//WriteLine(4 + 5);
//WriteLine("4 + 5");
//WriteLine("4" + "5");
...
//5
//WriteLine('a'); //char (character) | حرف علامت یا کاراکتر
//WriteLine("a" + "b");
//WriteLine('a' + 'b');
////WriteLine('ab');//error
...
//Variable | تعریف متغیر
//بر اساس نوع داده : dataType variableName = value;
//6
//int n = 7;
//WriteLine(n);
//WriteLine(n + 12);
...
//double d = 2.5;
//char ch = 'a';
//float num1 = 1.5f; //اعشاری تا 7 رقم
//decimal num2 = 1.5m; //اعشاری تا 27 رقم

//براساس مقدار اولیه : var variableName = value;
//7
//var n = 2.5d;
//var n = 7;
//var name = "sara";
...
//براساس مقدار لحظه ای : dynamic variableName = value;
//8
//dynamic n = 7;
//n = "farda";
//n = 2.5f;

//Const | تعریف ثابت یا غیر قابل تغییر
//const dataType variableName = value;
//9
//const double p = 3.14;
////p = 3;error

//Data Type Convert | تبدیل انواع داده
//Cast : تبدیل انواع عددی + object
//(dataType) value
//10 
//var n = 2.5;
//int a = (int)n;
...
//Convert : تبدیل هر چیزی به هر نوعی -> به شرط امکان تبدیل
...
//Parse : تبدیل متن! به هر نوعی -> به شرط امکان تبدیل
//dataType.Parse(stringValue)
//13
//Write("enter age : ");
//var age = int.Parse(ReadLine()); //ReadLine() -> دریافت ورودی از کاربر در محیط کنسول
//WriteLine(age + 100);
...
//    WriteLine("Wrong");
//}
//goto start; //jump -> بازگشت به لیبل تعریف شده
...
//        {
//            Write("valid");
//            Beep(3500, 5000); //Beep(زمان ,فرکانس)
//        }
